#!/bin/bash
template_path="/home/andy/wg_tmeplate"
...
case $wg_action in
    "add")
        ...
        sed -e "s/A.B.C.D/192.168.50.${ip_number}\/32/g" -e "s/KKKEY/${wg_public}/g" wg_tmeplate >> ${wgconf_path}${wg_name}
        echo "Your publickey"
        echo $wg_public
        echo "Your tunnel file"
        sed -e "s/A.B.C.D/192.168.50.${ip_number}\/24/g" -e "s/PPPRIKEY/${wg_private}/g" wg_tmeplate > ${key_path}${$wg_hostname}/tunnel
